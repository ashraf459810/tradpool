 ...
 listViewSample(
  ...
  return Card(
    child: container(
        ...
        hight: widget.auction.buyerRate !=null || widget.auction.sellerRate !=null ? h(400) :h(280),
        width: w(160),
  ...
  widget.fixedPrice !=null ? Row(mainAxisAlignment: MainAxisAlignment.center,
   ...
   widget.price=="_"? SizedBox(height: h(30),):SizedBox(),
       ...
       widget.auction.buyerRate!=null?              Row(
        ...
        hight: h(50),child: customlistview(padding: 1,
           ...
           widget.auction.buyerFeedback !=null?      text(text:"Buyer Feedback"       " "+ widget.auction.buyerFeedback,fontsize: 10.sp,color: AppColor.blue)
               :const SizedBox()  ,     
                ...
                widget.auction.sellerRate!=null?                   Row(
                 ...
                 //  auction.sellerRate
                  ...
                  ,function: (context,index){
                   return Icon(Icons.star ,  color: Colors.yellow[700],size: 20,);
                                    ...
                                    widget.auction.sellerFeedback !=null?      text(text: "Buyer Feedback"       " "+widget.auction.sellerFeedback,fontsize: 10.sp,color: AppColor.blue)
               :const SizedBox(),
